...
namespace IISIM {
    ...
    public partial class DeviceEFM : DeviceWindow {
        ...
        private void InitInterface () {
            ...
            Controls.EFMTracing fhrTracing = new (Instance, new Strip (Lead.Values.FHR, 600d, 600d, 100d), colorScheme);
            ...
            Controls.EFMTracing tocoTracing = new (Instance, new Strip (Lead.Values.TOCO, 600d, 600d, 100d), colorScheme);
