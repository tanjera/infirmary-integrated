...
@"                                 Apache License
   ...
   END OF TERMS AND CONDITIONS";
        ...
        public DialogEULA(App inst) : base("Infirmary Integrated")
        {
            Instance = inst;
        ...
        private void InitInterface () {
            ...
            Button btnHyperLink = new Button(new Label("https://github.com/tanjera/infirmary-integrated"));
            btnHyperLink.Halign = Align.Center;
            btnHyperLink.Pressed += (sender, args) =>  
            {
                string url = "https://github.com/tanjera/infirmary-integrated".Replace ("&", "^&");
                Process.Start("xdg-open", url);
            };
            vbMain.PackStart(btnHyperLink,false, false, 6);

            TextView tvLicense = new TextView();
            tvLicense.Halign = Align.Center;
            tvLicense.Editable = false;
            tvLicense.Buffer.Text = LicenseText;
            tvLicense.VscrollPolicy = ScrollablePolicy.Natural;
            
            ScrolledWindow swLicense = new ScrolledWindow();
            swLicense.MinContentWidth = 640;
            swLicense.MinContentHeight = 300;
            swLicense.Add (tvLicense);
            ...
            btnContinue.Halign = Align.Center;
            btnContinue.Pressed += (sender, args) =>  
            {
                this.Close();
            };
            vbMain.PackStart(btnContinue,false, false, 6);
